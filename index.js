...
// 카트에 추가 될 Li 생성 함수
const createCartItemLi = (item, drinkItemTitle) => {
...
const itemMoveInCart = (item, event) => {
...
const toggleNumToString = (any) => {
  if (typeof 1 === typeof any) {
    return any.toLocaleString('ko-KR');
  } else if (typeof 'str' === typeof any) {
    return parseInt(any.replace(',', ''));
  }
};
